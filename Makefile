...
analysis:
	cd code && $(PY) scripts/checkpoint_analysis.py --results ../$(R) \
	  ...
	  --latex-round3 ../$(P)/table_round3.tex --latex-ortho ../$(P)/table_ortho.tex --latex-a18 ../$(P)/table_a18.tex --latex-diagnostic ../$(P)/table_diagnostic.tex --latex-vit ../$(P)/table_vit.tex --latex-estimators ../$(P)/table_estimators.tex > ../$(R)/checkpoint_analysis.txt
