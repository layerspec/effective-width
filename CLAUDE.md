...
| 池化一致壓低水準 | 108/108 層 | **強烈倖存**；新穎性已查（2026-09-03）：Elmoznino & Bonner S6 做過「池化 vs 整張攤平」的穩健性檢查但未報水準，而且攤平是 CHW 維的另一個對象；逐層配對比較沒人做過。見 `notes/pooling-novelty-2026-09-03.md` |
