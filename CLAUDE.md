...
| 剖面是學出來的（非架構） | ResNet-50 同一批影像：隨機 vs 隨機 ρ 0.94、訓練 vs 訓練 0.84、訓練 vs 隨機 −0.08；ρ(depth) 隨機 −0.70、訓練 +0.56 | **候選主張**（2026-09-04）。只有 ResNet-50；其他架構與訓練軌跡未做。見 `notes/round2-2026-09-04.md` §6 |
...
3. 依新排序重寫 §I／§II 框架、標題、摘要、§V 形狀措辭（規則 7）。
